...
[![My Skills](https://skillicons.dev/icons?i=js,ts,py,java,spring,django,react,vite,html,css,bootstrap,tailwind,vitest,jest,cypress,selenium,gherkin,postman,mysql,postgres,sqlite,git,github,githubactions,gitlab,jenkins,docker,pycharm,vscode,ai)](https://skillicons.dev)
