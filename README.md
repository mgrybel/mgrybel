...
[![My Skills](https://skillicons.dev/icons?i=ts,js,py,bash,react,vite,spring,maven,gradle,html,css,bootstrap,tailwind,materialui,vitest,cypress,selenium,gherkin,postman,mysql,postgres,sqlite,mongodb,elasticsearch,graphql,git,github,githubactions,gitlab,jenkins,docker,kubernetes,vscode,ai)](https://skillicons.dev)
