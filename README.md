...
[![My Skills](https://skillicons.dev/icons?i=js,ts,py,java,django,spring,react,vite,html,css,tailwind,bootstrap,vitest,jest,cypress,selenium,gherkin,postman,mysql,postgres,sqlite,git,github,githubactions,gitlab,jenkins,docker,pycharm,vscode,ai)](https://skillicons.dev)
