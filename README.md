...
[![My Skills](https://skillicons.dev/icons?i=java,ts,js,py,cs,dotnet,spring,django,react,vite,html,css,bootstrap,tailwind,vitest,cypress,selenium,gherkin,postman,mysql,postgres,sqlite,git,github,githubactions,gitlab,jenkins,docker,vscode,idea)](https://skillicons.dev)
